                ...
                <div class="relative ml-3">
                    ...
                    <div id="user-dropdown" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-amber-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-10" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <div class="py-1" role="none">
                            ...
                            <button type="button" class="text-amber-200 px-3 py-2 rounded-md text-sm font-medium transition-all hover:bg-amber-700 hover:text-white duration-300 hover:bg-amber-700/80 hover:text-white flex items-center gap-1 relative" aria-label="Notifications">
                                <div class="relative">
