...
<nav class="fixed w-full bg-gradient-to-r from-amber-950 to-amber-800 backdrop-blur-md shadow-xl z-50 transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 md:h-20 items-center">
                ...
                <div class="relative ml-3">
                    ...
                    <div id="user-dropdown" class="hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-amber-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-10" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <div class="py-1" role="none">
                            ...
                            <a href="{{ route('notifications.index') }}" class="text-amber-200 px-3 py-2 rounded-md text-sm font-medium transition-all hover:bg-amber-700 hover:text-white duration-300 hover:bg-amber-700/80 hover:text-white flex items-center gap-1 relative" aria-label="Notifications">
                                <div class="relative">
            ...
            <!-- Search (desktop only) -->
            <div class="hidden md:block relative mt-[1rem]">
                <form action="{{ route('article.search') }}" method="GET">
                    ...
                    <input
                        ...
                        name="q"
                        placeholder="Search..."
                        class="pl-10 pr-4 py-2 w-full rounded-lg bg-amber-800/50 text-amber-100 placeholder-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-500">
                    <svg
                        class="w-5 h-5 absolute left-3 top-2.5 text-amber-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-xl md:text-2xl font-bold text-amber-100"></span>
            </div>
            @endif
        </div>
    </div>
