...
@endif
                ...
                <form class="space-y-6" method="POST" id="order-form" action="{{ route('commandes.store') }}">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <button type="submit" class="px-6 py-3 bg-amber-800 text-amber-100 rounded-lg font-semibold hover:bg-amber-700 transition-colors">
                            Complete Purchase
                        </button>
                    </div>
                </form>
